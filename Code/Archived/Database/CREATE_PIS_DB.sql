...
CREATE TABLE personnel (employeeID NUMBER(10) NOT NULL,firstName VARCHAR2(30), lastName VARCHAR2(30), idCard CHAR(8) UNIQUE, username CHAR(6) UNIQUE, passphrase CHAR(64), 
